import { updateUser, updatePetInDB, trackQuestProgress, calculateEloChange, setBattleActive } from '../../../utils/db';
import { calculateMaxXp, recalculatePetStats, getPlayerMaxXpForLevel } from '../../../utils/gameMechanics';
...
export const handleWin = async (state, showNotification, startBattleFn, reward, winningTeamIds, enemyRating, damageReport) => {
    ...
    if (isTower) {
        ...
        if (towerStage === currentProgress) {
            updates.towerProgress = currentProgress + 1;
        }
    }
