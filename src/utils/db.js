...
// ... (Restliche Imports und Funktionen bleiben gleich) ...
...
export const initializeUser = async (firebaseUser, username) => {
  ...
  if (userSnap.exists()) {
    ...
    // FIX: ISO Datum nutzen (YYYY-MM-DD) für Konsistenz
...
// ... (Hier folgen alle anderen Export-Funktionen: listenToUser, listenToPets, updateUser, etc. -> BITTE BEIBEHALTEN!)
