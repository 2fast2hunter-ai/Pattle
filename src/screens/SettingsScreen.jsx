...
import { ArrowLeft, Globe, LogOut, Music, Volume2, Scale, ChevronRight, ScrollText, MessageSquare, BarChart2 } from 'lucide-react';
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-8">
                ...
                {isAdmin && (
                    <div className="space-y-3">
                        ...
                        <button onClick={() => { onNavigate('admin'); playSound('click'); }} className="w-full flex items-center justify-between p-4 rounded-2xl bg-slate-900 border border-white/5 hover:bg-slate-800 transition-all active:scale-[0.98]">
                            <div className="flex items-center gap-4">
                                <div className="w-10 h-10 rounded-xl flex items-center justify-center bg-indigo-600/20 text-indigo-400">
                                    <BarChart2 className="w-5 h-5" />
                                </div>
                                <span className="font-bold text-white text-sm">Analytics Dashboard</span>
                            </div>
                            <ChevronRight className="w-4 h-4 text-slate-500" />
                        </button>
                    </div>
