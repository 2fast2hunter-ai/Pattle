...
import { ArrowLeft, Lock, CheckCircle, Swords, Gift, Coins, Gem, Package, FlaskConical } from 'lucide-react';
                    ...
                    return (
                        ...
                        >
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <div className="font-bold text-white text-sm">Gegner: {stage.enemyCount}x Lvl {stage.enemyLevel}</div>
