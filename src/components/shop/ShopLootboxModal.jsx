                ...
                <div className="p-4 bg-slate-900 border-t border-white/10 shrink-0 space-y-4">
                    {viewingBox !== 'DAILY' && (
                        <div className="flex justify-center items-center gap-4">
                            ...
                            <div className="text-center w-12"><span className="block text-xs text-slate-400 font-bold uppercase">{t ? t('shop_amount') : 'Amount'}</span><span className="block text-xl font-black text-white">{buyAmount}</span></div>
