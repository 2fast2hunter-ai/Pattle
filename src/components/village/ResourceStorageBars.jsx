...
import { RESOURCES, getStorageTotalForResource } from '../../data/gameData';
                ...
                {STORAGE_RESOURCE_IDS.map(resId => {
                    ...
                    return (
                        <div key={resId} className="flex items-center gap-2">
                            ...
                            <div className="flex-1 text-[8px] text-slate-600 font-bold uppercase">{res?.buildingLabel || resId}</div>
                            <span className="text-[8px] font-bold text-slate-500 text-right shrink-0">
